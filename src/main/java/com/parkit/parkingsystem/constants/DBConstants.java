...
/**
 * 
 * @author S063912 The SQL statements for the project
 */
public class DBConstants {
	...
	// OBA : Fix issue / Ajout where t.OUT_TIME is null
	...
	public static final String GET_OCC_VEH_NUMBER = "select count(*) as NB_OCC from ticket where VEHICLE_REG_NUMBER=? and OUT_TIME is not null";
}
